...
if(resposta && resposta.includes("PEDIDO_DELIVERY_JSON:")){
  ...
  try{
    ...
    console.log("🧾 PEDIDO DA IA:", pedidoJSON)

    const dados = pedidoJSON.dados

    // 🔥 REMOVE QUALQUER PEDIDO ANTERIOR
    await supabase
      .from("pedidos_pendentes")
      .delete()
      .eq("cliente_telefone", cliente)
    ...
    console.log("✅ PEDIDO SALVO EXATAMENTE COMO VEIO DA IA")
